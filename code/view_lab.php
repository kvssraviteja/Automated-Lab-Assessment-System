...
$server="localhost";
	...
	if(mysqli_select_db($conn,"course_db"))
	{
		...
		echo "<form class=\"form-signin\" action=\"view_lab1.php\" method=\"POST\" target=\"_top\">";
		echo "<h3>VIEW LAB</h3>";
		echo "<br>";
		 echo "Select year:
		...
		echo "select semester:
			<select name=\"sem\" class=\"selectpicker\">
		...
		echo "select sec:
			<select name=\"sec\" class=\"selectpicker\">
		...
		echo "<input type=\"text\" class=\"input-block-level\" name=\"lab_no\" >";
		echo "<br>";
		echo "<center>  <button class=\"btn btn-large btn-primary\" type=\"submit\" name=\"view\" >VIEW</button>";
		echo "</form>";
